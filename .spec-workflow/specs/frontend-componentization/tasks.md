...
- [ ] 2. 建 `utils/note.ts`（迁入 extractOutline + openNoteFromMeta）
...
- [ ] 3. 建 `utils/tree.ts`（迁入 makeCompare/childDirs/fileIcon）
...
- [ ] 4. 提取 `useWikilinkNavigation` hook
...
- [ ] 5. NoteView / TasksPage 接入 useWikilinkNavigation
